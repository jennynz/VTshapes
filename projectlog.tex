    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Despite what we say about NZE `fush'n'chups', our hid vowel is still higher than AmE hid, even AmE \textipa{3}.
            ...
            \begin{itemize}
                ...
                \item This sound that we hear can not directly represent the resonances of the vocal tract, because it has been combined with the effects of lip rounding, and the wave shape coming out of the glottal filter.
                \item Resonance plots derived from MRI images are free from such factors. It allows us to look just at the resonances of the vocal tract. This can help with better modelling the vocal tract from a physiological/acoustic perspective.
                \item Resonance plots could also be derived from acoustic reflectometry data, but the device enforces lip rounding which as seen above, has a significant effect on the formants of the vocal tract.
                \item \hl{Make some formant plots with Daniel's formant data} to help when describing this, to show how different the formant plot is and vowels with lip rounding (3, u etc.) moving up and back.
                \item NZE tends to be crowded at the front only in formant plots - on our resonance plots, we don't really see this. If we assume that the crowding is due to the auxiliary effects of lip rounding, glottal waveform, and all the other things we're simplifying like the elasticity of the vocal tract walls, the size of the teeth (since we are assuming that the R1/R2 plot is the most `pure' representation of vocal tract shape/tongue position, which is the main determinant of vowel quality), we could argue that it's not that NZE speakers are lazy with tongue position, it's just that our tendency to lip round some vowels results in crowding of the VT space, despite this decreasing the phonetic distance between the phonemically distinct vowels. So really, 1) NZE speakers are not lazy in how we speak (it's not our intention, or not our VT shapes' intention anyway, to not move around a lot) and 2) NZE speakers have great ears for distinguishing similar vowels!
            \end{itemize}
            \item \hl{Try R1/R2 plots splitting by gender}
            \item NZE `lazy'
            \begin{itemize}
                \item It is not valid to say that NZE looks more clumped therefore supports the stereotype that NZE speakers are lazy with enunciation.
                \item If anything, NZE vowels seem to crowd the front space, but AmE seems to crowd the back. Their vowels are overall more back than us.

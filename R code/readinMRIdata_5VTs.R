...
# Area functions (cross-sectional area vs. distance from lips) from VT03, VT05, VT08, VT09, and VT10 are read into R and interpolated with the same number of points as the original matrix.
# Assumes one set only.
...
VTlist <- list.dirs(path, recursive=FALSE, full.names=FALSE)[c(3,5,8:10)]
